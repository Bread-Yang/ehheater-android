...
public class MarqueeView extends LinearLayout {
	...
	/**
	 * Sets the animation speed. The lower the value, the faster the animation
	 * will be displayed.
	 * 
	 * @param speed
	 *            Milliseconds per PX.
	...
	private void extractAttributes(AttributeSet attrs) {
		...
		mAnimationPause = a.getInteger(R.styleable.MarqueeView_pause,
				DEFAULT_ANIMATION_PAUSE);
